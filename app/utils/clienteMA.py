...
class ClienteMA(Cliente):
    def __init__(self,args):
        ...
        self.URL_ART = "https://servicos-crea-ma.sitac.com.br/app/view/sight/ini?form=Art&id="
    ...
    def cadastrar(self,browser,numero_art):
        ...
        try:
            ...
            select = Select(element_select)
            select.select_by_value("1018")#consultoria
        except:
            element_select = WebDriverWait(browser, self.TIME_TO_WAIT).until(
        ...
        select = Select(element_select)
        select.select_by_value("4389")#atividade profissional (consultoria)
